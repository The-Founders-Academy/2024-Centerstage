...
@Autonomous(name="RedTwo", preselectTeleOp ="2024TeleOp")
public class RedTwo extends OpMode {
    ...
    public void init() {
        ...
        m_drivetrain = new MecanumDrivetrain(null, hardwareMap, "fL",
                "fR", "bL", "bR");
        CommandScheduler.getInstance().schedule(new DriveForTime(m_drivetrain,  0.5, -0.2));
        t.start();
    }
